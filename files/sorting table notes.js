const artists = [
  ...
  /* Suppose that this js file gets loaded by the browser when it parses some html file, and suppose that 
  the html file has a button as in the table-sort assignment.Then you could use the above ideas to add
  an event-listener to the button to show a randomly-selected artist:
  */
